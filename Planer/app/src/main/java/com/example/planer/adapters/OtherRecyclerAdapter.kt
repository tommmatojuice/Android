...
import kotlinx.android.synthetic.main.other_task.view.*
import kotlinx.android.synthetic.main.rest_task.view.*
import java.time.LocalDate
import java.time.format.DateTimeFormatter

class OtherRecyclerAdapter(
    context: Context,
...
): RecyclerView.Adapter<OtherRecyclerAdapter.ViewHolder>()
{
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        return ViewHolder(inflater.inflate(R.layout.other_task, parent, false))
    }
    ...
    inner class ViewHolder(taskView: View) : RecyclerView.ViewHolder(taskView), View.OnClickListener{
        private val date: TextView = taskView.other_task_date
        private val title: TextView = taskView.other_task_title
        private val group: TextView = taskView.other_group_title
        private val priority: ImageView =  taskView.other_priorityImageView
        private val card: CardView = taskView.other_card_view
